...
// function CallbackUrlWatcher({ onDetected }: { onDetected: () => void }) {
...
//   const [mode, setMode] = useState("login"); // Controls whether we show Login or Sign Up
...
//   // The master function that handles both Logging in and Signing up
...
//     if (mode === "signup") {
//         // Step 1: Create the user in the database via our new API route
...
//             return;
//         }
//         // If sign up is successful, the code continues down and automatically logs them in!
//     }

//     // Step 2: Authenticate the user (for both login and auto-login after signup)
//     const result = await signIn("credentials", {
//         redirect: false, // Prevents Next.js from aggressively reloading the page
//         email,
//         password,
//     });
...
//     } else {
//         setIsOpen(false);
//         router.refresh(); // Updates the Navbar UI
//     }
